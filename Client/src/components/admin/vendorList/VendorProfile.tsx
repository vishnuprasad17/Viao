...
import { getVendorProfile, blockVendors, updateVerify } from '../../../config/services/adminApi';
...
const VendorProfile = () => {
    ...
    blockVendors(Id)
      .then((response) => {
        ...
        setVendor((prevVendor) =>
          prevVendor ? { ...prevVendor, isActive: !prevVendor.isActive } : undefined)
  ...
  const updateVerifyStatus = async(status:string) => {
    updateVerify({vendorId:vendor?._id,status:status},{withCredentials:true})
      .then((response) => {
