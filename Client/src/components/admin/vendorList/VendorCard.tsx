    ...
    />
      ...
      <Card
        ...
        <CardHeader
          ...
          shadow={false}
          color="transparent"
          style={{ backgroundImage: `url(${coverpicUrl?coverpicUrl:"/imgs/vendor/default-cover.jpg"})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}
